...
Strategy.prototype.authenticate = function(req, options) {
  ...
  // A hack to make the callback request automatic regardless the domain or the use of https/www
  options.callbackURL = req.protocol + "://" + req.get('host')+'/auth/twitter/callback';
